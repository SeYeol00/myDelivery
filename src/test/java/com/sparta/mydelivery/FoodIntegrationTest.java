    ...
    class RegisterRestaurants {
        ...
        void test3() throws JsonProcessingException {
            ...
            FoodDto food4Response = Arrays.stream(foodsResponse)
                    .filter(food -> food4.getFoodName().equals(food.getFoodName()))
                    .findAny()
                    .orElse(null);
            assertNotNull(food4Response);
            assertNotNull(food4Response.getId());
            assertEquals(food4.getFoodName(), food4Response.getFoodName());
            assertEquals(food4.getFoodPrice(), food4Response.getFoodPrice());
        }
    }
